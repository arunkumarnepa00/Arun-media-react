        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-light" style={{backgroundColor:'#383CC1'}}>
                ...
                <div className="container-fluid">
                    ...
                    <form className="d-flex col-6 d-none d-sm-flex">
                    ...
                    {/* mobile view */}
                    <ul className="navbar-nav d-flex flex-row d-sm-none ms-auto me-2">
                        ...
                        <li className="nav-item ms-4">
                            <Link to={`/profile/${user._id}`}>
                                <img src={img || require('../assets/images/noprofilepic.png')} alt='profile'
                    ...
                    <div className="collapse navbar-collapse col-sm-2 col-10 ms-4" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item ms-4 d-none d-sm-inline">
                                <Link to={`/profile/${user._id}`}>
                                    <img src={img || require('../assets/images/noprofilepic.png')} alt='profile'
                                        width="35" height="35" className="rounded-circle"></img>
                                </Link>
